...
namespace WindowsFormsApp1
{
    public partial class Sayı_genel_hesaplama : Form
    {
        ...
        {
                int birler, onlar, yuzler, sayi, kup;
                for (int i = 100; i < 1000; i++)
                {

                    sayi = i; //Convert.ToInt32(textBox1.Text);
                    if (sayi > 99 && sayi < 1000)
                    {
                        ...
                        kup = (yuzler * yuzler * yuzler) + (onlar * onlar * onlar) + (birler * birler * birler);
                        ...
                        lb_genel.Items.Add((yuzler * yuzler * yuzler) + " + " + (onlar * onlar * onlar) + " + " + (birler * birler * birler) + " =" + kup);
